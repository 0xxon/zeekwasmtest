...
export class Session {
    ...
    hover(uri, line, col) {
        ...
        const ret = wasm.session_hover(this.__wbg_ptr, ptr0, len0, line, col);
     ...
     * @returns {any}
     */
    complete(uri, line, col) {
        const ptr0 = passStringToWasm0(uri, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.session_complete(this.__wbg_ptr, ptr0, len0, line, col);
        return takeObject(ret);
    }
    /**
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('zeek_lsp_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
